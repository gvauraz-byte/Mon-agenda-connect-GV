...
- **Titres rapides** : dans le formulaire d'ajout d'un evenement, des boutons "Repetition", "Generale", "Representation", "Montage decor", "Demontage decor", "Tournee" pre-remplissent le titre en un clic.
