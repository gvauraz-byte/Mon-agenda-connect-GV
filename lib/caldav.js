...
function buildEventICS({ uid, title, start, end, allDay, category, location }) {
...
export async function createEvent({ title, start, end, allDay, category, calendarUrl, location }) {
  const c = await getClient();
  const calendars = await listCalendars();
  ...
  const ics = buildEventICS({ uid, title, start, end, allDay, category, location });
...
export async function updateEvent({ url, etag, uid, title, start, end, allDay, category, location }) {
  const c = await getClient();
  const ics = buildEventICS({ uid, title, start, end, allDay, category, location });
